...
if exists (select * from msdb.dbo.sysjobs_view where name = N'(dba) Remove-XEventFiles')
...
SELECT @ReturnCode = 0
/****** Object:  JobCategory [(dba) Monitoring & Alerting]    Script Date: 5/9/2022 11:38:14 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'(dba) Remove-XEventFiles', 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'Remove files generated by XEvent [resource_consumption] from disk', 
