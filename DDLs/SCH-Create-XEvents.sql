...
IF NOT EXISTS (SELECT * FROM sys.server_event_sessions WHERE name = 'resource_consumption')
BEGIN
...
if not exists (select * from sys.dm_xe_sessions where name = 'resource_consumption')
